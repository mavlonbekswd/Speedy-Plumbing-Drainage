...
//
// The two forms are one contract in two shapes: the inline callback card
// beside the hero and the full booking form in `section#book` (every service
// page, and /contact). The six-step wizard on /quote was removed on 19 Sept 2026.
// A defect in any of them costs a lead, so each one is held
